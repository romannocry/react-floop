...
function Tab({ surveyElement, survey }) {
    ...
    const generateMatrix = (e) => {
        ...
        //console.log("generating matrix based on two Qs below")
        //console.log("**selected question params from event**")
        //console.log(survey[e.target.value].urlParams)
        //console.log("**initial question params from parent**")
        //console.log(surveyElement.urlParams)
